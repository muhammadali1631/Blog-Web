  ...
  return (
    <div className=''>
        <div className='flex flex-col justify-center items-center'>
            <h1 className='text-3xl sm:text-4xl font-bold my-10'>Programming Blogs</h1>
        ...
        <div className='flex flex-col justify-center items-center'>
            <h1 className='text-3xl sm:text-4xl font-bold my-10'>Personal Development</h1>
            <div className='flex flex-wrap justify-around w-[100%] gap-10 '>
        ...
        <div className='flex flex-col justify-center items-center'>
            <h1 className='text-3xl sm:text-4xl font-bold my-10'>Health & Fitness</h1>
            <div className='flex flex-wrap justify-around w-[100%] gap-10 '>
