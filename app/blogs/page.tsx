  ...
  return (
    <div>
       ...
       <div className='flex flex-wrap w-[100%] justify-around gap-10'>
                {data.map((item) => (
                    <div key={item.title} className='bg-[#09003d] text-[#fff] p-8 gap-5 rounded-xl w-[350px] grid justify-between box-shad text-center sm:w-[500px] cursor-pointer mb-7 scale-in-bottom1 hover:bg-[#090111] hover:duration-700 hover:ease-in-out'>
